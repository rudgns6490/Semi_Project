 ...
 */
	...
	$(document).ready(function(){
		...
		$("#btnConfirm-input").click(function(){
			...
			frm.action = "verifyCertification.ysl"
			frm.method = "POST";
			frm.submit();
	/*		
...
<header>
	<div>
		<%-- Saint Laura LOGO --%>
		<div id="logo"><img alt="YSL" src="images/main-logo-white.png"></div>
		...
		<div id="myPwdFindNav" class="sidenav">
			...
			<div style="padding:20px;">
				...
				<form name="pwdFindFrm" style="margin-top:30px">
	  				...
	  				<input type="email" class="pwdFind-input" name="email" id="pwdFindEmail" style="display:block" />
