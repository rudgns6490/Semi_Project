...
////////// 2. 아이디 검사 (정규표현식)
		...
		});	//endof $("input#userid").blur(function()--------	
...
////////// 4. 비밀번호 확인 검사
		$("input#passwdCheck").blur(function(){
			if( $(this).val() != $("input#passwd").val() ){
				...
				$("span.passwdCheck_error").css('display','none');
			}
		});
...
////////// 5. 이름 검사		
		$("input#name").blur(function(){
			if( $(this).val().trim() =="" ){
				$("span.name_error").html("이름은 필수 입력 사항입니다.");
			}
			else{
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li class="active"><a href="#">STOCKIST</a></li>
        <li><a href="#">COMMUNITY</a></li>
        <li><a href="#">ONLINE STORE</a></li>
      </ul>
      <img src="#" style="margin:auto;">이곳에 이미지가 들어옵니다
      <ul class="nav navbar-nav navbar-right">
        <li><a href="#"><span class="glyphicon glyphicon-log-in"></span> Korea</a></li>      	 
        <li><a href="#"><span class="glyphicon glyphicon-log-in"></span> English</a></li>      
        <li><a href="#"><span class="glyphicon glyphicon-log-in"></span> 로그인</a></li>      
        <li><a href="#"><span class="glyphicon glyphicon-log-in"></span> 회원가입</a></li>      	 
        <li><a href="#"><span class="glyphicon glyphicon-log-in"></span> 주문조회</a></li>      
        <li><a href="#"><span class="glyphicon glyphicon-log-in"></span> 내정보</a></li>      
        <li><a href="#"><span class="glyphicon glyphicon-log-in"></span> 장바구니</a></li>      	 
...
<!-- -----------------------------------------------------HEADER 부분------------------------------------------------------ -->
<!-- -----------------------------------------------------회원가입 부분------------------------------------------------------ -->
<div style="background: white; width: 80%; min-height:500px; margin: 50px auto; padding: 50px;">
	<div class="row">
		<div class="col-sm-4" style="font-size: 14pt; font-weight: bold; color: #33334d;">회원가입</div>
		<div class="col-sm-8" style="font-size: 8pt; font-weight: bold; text-align: right;">홈   > 회원가입</div>
	</div>
	<hr>
	<div class="top_container" style="width: 98%; margin: 0 auto;">
	 	<div class="input-group">
	      ...
	      <input id="userid" type="text" maxlength="16" class="form-control" name="userid" placeholder="사용자 아이디" style="width: 50%" required autocomplete="off" />
	      <span></span>
	    </div>
	  	<div class="input-group">
	      <span class="input-group-addon"><i class="glyphicon glyphicon-lock">&nbsp;비밀번호&nbsp;&nbsp;</i></span>
	      <input id="password" type="password" maxlength="16" class="form-control" name="password" placeholder="비밀번호" style="width: 50%" required />
	      <span></span>
	    </div>
	  	<div class="input-group">
	      <span class="input-group-addon"><i class="glyphicon glyphicon-lock">&nbsp;비밀번호확인</i></span>
	      <input id="PasswordCheck" type="password" maxlength="16" class="form-control" name="PasswordCheck" placeholder="비밀번호 확인" style="width: 50%">
	      <span></span>
	    </div>
	  	<div class="input-group">
	      <span class="input-group-addon"><i class="glyphicon glyphicon-user">&nbsp;이름&nbsp;&nbsp;&nbsp;&nbsp;</i></span>
	      <input id="username" type="text" maxlength="16" class="form-control" name="username" placeholder="이름" style="width: 50%" autocomplete="off" required />
	      <span></span>
	    </div>
	  	<div class="input-group">
	      <span class="input-group-addon"><i class="glyphicon glyphicon-signal">&nbsp;휴대전화&nbsp;&nbsp;</i></span>
	      <input id="mobile" type="tel" maxlength="11" class="form-control" name="mobile" placeholder="휴대전화 ('-' 생략 : 01012345678)" style="width: 50%" autocomplete="off" required />
	      <span></span>
	    </div>
	  	<div class="input-group">
	      <span class="input-group-addon"><i class="glyphicon glyphicon-envelope">&nbsp;이메일&nbsp;&nbsp;&nbsp;</i></span>
	      <input id="email" type="text" maxlength="40" class="form-control" name="email" placeholder="이메일 (예: abcd@gmail.com)" style="width: 50%" autocomplete="off"  required />
	      <span></span>
	    </div>
	  	<div class="input-group">
	  	  <span class="input-group-addon"><i class="glyphicon glyphicon-home">&nbsp;주소&nbsp;&nbsp;&nbsp;&nbsp;</i></span>
	  	  <span><input id="address2" type="text" class="form-control" name="address" placeholder="1" style="width: 8%;" maxlength="6" readonly="readonly" required /></span>
	  	  <span><input type="button" class="btn btn-info btn-sm" value="우편번호 검색"></button></span>
...
<div class="container" style="width: 100%;">
	  ...
	  <div class="panel-group">
		    <div class="panel panel-default">
		      ...
		      <div class="panel-heading" style="border-bottom: solid white 0.5px;">
		        <h4 class="panel-title">
		          	전체 동의<span><input type="checkbox" style="float: right;" /></span>
		        </h4>
		      ...
		      <div class="panel-heading" style="border-bottom: solid white 0.5px;">
		        <h5 class="panel-title">
		          <a data-toggle="collapse" href="#collapse1">[필수] 이용약관 동의</a><span><input type="checkbox" style="float: right;" /></span>
		        </h5>
		      </div>
		      ...
		      <div class="panel-heading">
		        <h5 class="panel-title">
		          <a data-toggle="collapse" href="#collapse2">[필수] 개인정보 수집 및 이용 동의</a><span><input type="checkbox" style="float: right;" /></span>
		        </h5>
		      </div>
  	...
  	<div class="row" >
  		...
  		<div class="col-sm-2" style="font-size: 10pt; font-weight: bold;"><button type="button" class="btn btn-primary btn-lg">회 원 가 입</button> </div>
  		<div class="col-sm-5" style="font-size: 10pt; font-weight: bold;"></div>
	</div>
</div>
...
<div>
  ...
  <div class="row">
	  ...
	  <div class="col-sm-2">
	  	  <p style="font-size: 10pt;">CS center</p>
	  	  <br />
	  	  <p style="font-size: 12pt;">1899-1234</p>
	  	  <p style="font-size: 8pt;">OPEN AM10:00 ~ PM6:00</p>
	  	  <p style="font-size: 8pt;">LUNCH PM12:00 ~ PM01:00</p>
	  	  <p style="font-size: 8pt;">SAT, SUN, HOLIDAY OFF
</p>
	  </div>
	  <div class="col-sm-2">
	  	  <p style="font-size: 10pt;">Bank Info</p>
	  	  <br />
	  	  <p style="font-size: 8pt;">우리은행: 1234-123-123456</p>
	  	  <p style="font-size: 8pt;">예금주: 이모저모</p>	  	      
	  </div>
	  <div class="col-sm-2">
	  	  <p style="font-size: 10pt;">Shop Menu</p>
	  	  <br />
	  	  <p style="font-size: 8pt;">NOTICE</p>
	  	  <p style="font-size: 8pt;">MY PAGE</p>
	  	  <p style="font-size: 8pt;">ABOUT</p>
	  	  <p style="font-size: 8pt;">STOCKIST</p>		
	  </div>
	  <div class="col-sm-2">
	  	  <p style="font-size: 10pt;">Follow</p>
	  	  <br />
	  	  <span style="font-size: 8pt;">Instagram</span>
	  	  <span style="font-size: 8pt;">Facebook</span>
	   </div>
	  <div class="col-sm-2"></div>
...
<footer style="background-color: white;">
  <div class="row">
	  <div class="col-sm-2"></div>
	  <div class="col-sm-2">
	  	  <a href="localhost:9090/SemiCab/main.ej"><img src="logo.png"></a>
	  </div>
	  <div class="col-sm-6">
	  	  <p style="font-size: 8pt;">Company: 이모저모     CEO: 홍길동     Tel: 1899-1234     Fax: 070-1234-1234      Business Registration No: [123-12-12345]     E-commerce Permit: 2016-SeoulJung-04092[사업자정보확인]</p>
	  	  <p style="font-size: 8pt;">Address: 06017 606, NamsanDaero 123, Jung-gu, Seoul, Republic of Korea      Personal Information Manager: EMJM(emjm@gmail.com)</p>
	   </div>
	  <div class="col-sm-2"></div>
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li class="active"><a href="#">AGREEMENT</a></li>
        <li><a href="#">PRIVACY POLICY</a></li>
        <li><a href="#">GUIDE</a></li>
      </ul>
	<ul class="nav navbar-nav navbar-right">
        <li style="color:white;">Copyright © 이모저모. All rights reserved. hosting by KH정보교육원(주)</li>      	 
