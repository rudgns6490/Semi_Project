...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function registerGo(){
			...
			var boolId = regExpId.test($("#userid").val());
			var regExpPassword = /^.*(?=^.{8,16}$)(?=.*\d)(?=.*[a-zA-Z])(?=.*[^a-zA-Z0-9]).*$/g;
			var boolPassword = regExpPassword.test($("#password").val());
			var regExpMobile2 = /^[0-9][0-9][0-9][0-9]$/g;
			var boolMobile2 = regExpMobile2.test($("#mobile2").val());
			var regExpMobile3 = /^[0-9][0-9][0-9][0-9]$/g
			var boolMobile3 = regExpMobile3.test($("#mobile3").val());
			...
			var agreeCheck = $("input:checkbox[name=allcheck]").is(":checked");
			var boolTel = regExpMobile.test($("#tel").val());
			var genderCheck = $("input:radio[name=gender]").is(":checked");
			var regExpBirthday = /^[0-9]{8}$/;
			var boolBirthday = regExpBirthday.test($("#birthday").val());
...
// 			8. 생년월일 검사	
			// 정규표현
			if(!boolBirthday){
				alert("생년월일은 숫자만 입력가능하며  8자리 입니다. 예)19990505 ");
				flag = false;
				$(this).html("");
				return;
			} else {flag = true;}
...
// 			15. 최종 서브밋
			// 서브밋
			if(flag){
				var frm = document.regsterFrm;
			
				frm.method = "POST";
				frm.action = "memberRegisterAction.ej";
				frm.submit();
			}
...
<div style="background-color: #f2f2f2;">
	...
	<div class="title">
		<div class="title_1">
			...
			<div class="title_1_1 title_1_1_1"><strong>회원가입</strong></div>
			<div class="title_1_1 title_1_1_2"><span class="side_title"><a href="main.ej">홈</a>	>	회원가입</span></div>
		</div>
	</div>
		...
		<table>
			...
			<tbody>
				<tr>
					...
					<td>
						<input id="userid" name="userid" class="inputTypeText" placeholder="예)leess7" type="text">
						<span class="msg" id="useridMsg"></span> (영문소문자/숫자, 5~15자)
					</td>							
				</tr>
				<tr>
					<th> 
						비밀번호<img src="//img.echosting.cafe24.com/skin/base/common/ico_required.gif" alt="필수">
					</th>
					<td>
						<input id="password" name="password" class="inputTypeText" placeholder="abcd1234!@#$" type="password">
						<span class="msg" id="passwordMsg"></span> (영문 대소문자/숫자/특수문자 중 2가지 이상 조합, 10자~16자)  
					</td>
				</tr>
				<tr>
					<th> 
						비밀번호 확인<img src="//img.echosting.cafe24.com/skin/base/common/ico_required.gif" alt="필수">
					</th>
					<td>
						<input id="passwordCheck" class="inputTypeText" placeholder="" value="" type="password">
				...
				<tr>
					...
					<td>
						<input id="username" name="username" class="inputTypeText" placeholder="" value="" type="text">
				...
				<tr>
					...
					<td>
						<select style="font-size:7pt; height: 18px; width: 40px;" id="mobile1" name="mobile1">
				...
				<tr>
					...
					<td>
						<input id="tel" name="tel" class="inputTypeText" placeholder="" value="" type="text"  maxlength="11" />
					</td>
				</tr>
				<tr>
					<th> 
				...
				<tr>
					...
					<td>
						<input maxlength="8" id="birthday" name="birthday" class="inputTypeText" placeholder="예)19950301" value="" type="text">
				...
				<tr>
					...
					<td>
						<input style="width: 20%;" maxlength="50" id="address1" name="address1" class="inputTypeText" placeholder="주소검색을 눌러주세요" readonly value="" type="text">
						<input style="width: 20%;" maxlength="50" id="address2" name="address2" class="inputTypeText" placeholder="상세주소를 입력해주세요" value="" type="text">
						<input style="width: 5%;" id="postnum" name="postnum" class="inputTypeText" placeholder="우편번호" readonly value="" type="text">
						<span class="msg" id="birthdayMsg"></span> 
				...
				<tr>
					...
					<td>
						<input type="radio" name="gender" id="male" value="1" />남자
						&nbsp;&nbsp;
						<input type="radio" name="gender" id="female" value="2" />여자
						<span class="msg" id="birthdayMsg"></span> 
					</td>
				</tr>
			</tbody>
	...
	<div style="width: 100%; height: 40px; background-color: #f2f2f2;"> </div>
</div>
