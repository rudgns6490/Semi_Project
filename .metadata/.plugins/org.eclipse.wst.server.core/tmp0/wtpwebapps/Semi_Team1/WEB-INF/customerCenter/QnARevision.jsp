...
<script>
	...
	$(document).ready(function(){
		...
		var title = "${ qnaMap.title }";
		var writer = "${ qnaMap.writer }";
		...
		$("#submitBtn").click(function(){
			...
			if(confirm("수정하시겠습니까?") == true ){
				...
				frm.action = "<%= request.getContextPath() %>/customer/customerQnArevise.dog";
				frm.submit();
			}
			else {
				return false;	
	...
	<div class="writeboard">
		<form class="qnaWriteForm" name="qnawritefrm" id="qnawritefrm" method="POST" >
			...
			<textarea name="contents" id="contents" cols="80" rows="30" style="width: 100%; margin: 20px auto; padding:10px 20px;" 
				onKeyUp="javascript:fnChkByte(this,'3000')">${ qnaMap.content }</textarea>		
