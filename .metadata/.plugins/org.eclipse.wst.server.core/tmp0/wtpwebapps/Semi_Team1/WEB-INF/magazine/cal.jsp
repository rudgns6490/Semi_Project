   		...
   		<form name="form_kcal" method="post">
            ...
            <div class="petInfoArea pet-basic">   
                <dl style="margin-top: 30px;">
                    <dt>반려견 이름은</dt>
                    <dd><div class="inputArea"><input type="text" name="name" id="name" class="infoData" style="border: none; width: 280px; font-size: 13pt; text-align: center;" /></div></dd>
                </dl>
                ...
                <dl>
                    <dt>견종은</dt>
                    <dd><select name="pet_type" class="infoData" style="font-size: 12pt;">
                ...
                <dl>
                    <dt>중성화 수술은</dt>
                    <dd>
                        <label><input type="radio" name="operation" value="1" class="MS_input operation infoData"> 수술함</label>
                        <label><input type="radio" name="operation" value="0" class="MS_input operation infoData"> 안함</label>
                    </dd>
                </dl>
                ...
                <dl>
                    <dt>성별은</dt>
                    <dd>
                        <label><input type="radio" name="sex" value="1" class="MS_input sex infoData"> 남자</label>
                        <label><input type="radio" name="sex" value="2" class="MS_input sex infoData"> 여자</label>
                    </dd>
                </dl>                        
                
                <dl>
                    <dt>몸무게는</dt>
                    <dd><div class="inputArea"><input type="text" class="infoData" name="weight" style="border: none; width: 250px; font-size: 13pt; text-align: center;" /><span style="font-size: 15pt; font-weight: bold;">kg</span></div></dd>
                </dl>
            </div>
