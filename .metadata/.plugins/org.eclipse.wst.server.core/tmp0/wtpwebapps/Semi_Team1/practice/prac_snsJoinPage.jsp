	...
	<div class="col-xs-9 col-md-8">
		...
		<div id="body_body">
			...
			<div id="body_joinbody">
				...
				<form action="snsMemberRegisterForm" style="border-bottom:solid 1px #e6e6e6; ">
				...
				<!-- SNS 에서 받아온 이름, 이메일 정보 -->
					...
					<div id="snsJoinNecessary">
						<table>
							...
							<tr>
								<td><input name="email" id="email" style="width:100%" placeholder="이메일 주소"/></td>
							</tr>
						...
						<table>
							...
							<tr >
								<td colspan="2">
									...
									(&nbsp;<input id="agree5" class="agreeCB" type="checkbox"><label for="agree5">이메일</label>)<br>
