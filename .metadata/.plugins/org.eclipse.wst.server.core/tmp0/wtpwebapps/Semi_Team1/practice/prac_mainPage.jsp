...
<div id="header">
	<div id="header1" >
        ...
        <div class="col-xs-9 col-md-8">
        	<img width="300" height="80" src="images/mainLogo.png" style="margin-top:20px;cursor:pointer;" onclick="">
  			<ul id ="loginBar">
  				<li><a>LOGIN</a></li>
   				<li><a>JOIN</a></li>
  				<li><a>ORDER</a></li>
	...
	<div id="header2" class="row">
        ...
        <div class="col-xs-9 col-md-8" id="navbar">
        	<div  id="navbarMenu">
            	<ul id="navbarUl">
                	<li style="width:8%;font-weight:bold;font-size:13pt;text-align:center;padding:15px 0;"><a><img alt="" src="images/list.png"></a></li>
                    ...
                    <li style="width:7%;"></li>
                    <li style="width:16%; position:relative; border-bottom:solid 1px black;"><input id="search" size="15" onclick="" />
                    	<a id="searchIcon"><img width="23" height="23" src="/Semi_Team1/images/search.png" /></a>
                    </li>
                    <li style="width:7%; text-align: end;"><a><img src="images/user-image-with-black-background.png"></a></li>
                    <li style="width:7%; text-align: end;"><a style="padding:0; position: relative;" class="notification"><img alt="장바구니" src="/Semi_Team1/images/shopping-cart.png"><span class="badge">0</span></a></li>
                </ul>
            </div>
    ...
    <div class="col-xs-9 col-md-8" style="padding:0;text-align:center;">
      ...
      <div class="footer-box" style="width:15%;">
          ...
          <ul id="fb_images"  style="text-align:right;">
              <li><a><img src="/Semi_Team1/images/facebook-logo.png"></a></li>
              <li><a><img src="/Semi_Team1/images/naver_blog_logo.png" width="32" height="32" ></a></li>
              <li><a><img src="/Semi_Team1/images/instagram-logo.png"></a></li>
          </ul>
      </div>
    </div>
</div>
