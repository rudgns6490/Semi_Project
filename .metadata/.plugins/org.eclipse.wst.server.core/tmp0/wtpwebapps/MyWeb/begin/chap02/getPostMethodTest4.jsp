...
<head>
<meta charset="UTF-8"> 
<title>getPostMethodTest4.jsp 페이지</title>
...
<body>
	<form name="memberFrm" action="<%= ctxPath%>/getPostMethodTest3.eclass" method="get">
	<%-- submit 을 하면 <%= ctxPath%>/getPostMethodTest3.do 로 보내어서 처리를 요청한다.
	     /MyWeb/getPostMethodTest3.do 은 누가 처리를 해주는지 배치서술자인 web.xml 에 기술되어져 있어야 한다.
	     web.xml 에 가보면 <servlet-mapping>에 URL 패턴으로 /getPostMethodTest3.do 이 기술되어져 있고,
