 ...
 * Generated at: 2019-12-19 10:16:49 UTC
...
public final class paymentGateway_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("   IMP.init('imp15618333');  // 중요!!  아임포트에 가입시 부여받은 \"가맹점 식별코드\". \r\n");
      out.write("\t\r\n");
      out.write("   // 결제요청하기\r\n");
      ...
      out.write("       name : 'ysl결제',\t // 코인충전 또는 order 테이블에 들어갈 주문명 혹은 주문 번호. (선택항목)원활한 결제정보 확인을 위해 입력 권장(PG사 마다 차이가 있지만) 16자 이내로 작성하기를 권장\r\n");
      out.write("       amount : parseInt('");
      ...
      out.write("    \t\t   \t         // 휴대폰 사용시 결제 완료 후 action : 을따로 적어줘야 한다. 컨트롤러로 보내서 자체 db에 입력시킬것!\r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${coinmoney}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("');\";\r\n");
      out.write("\t\t//  결제 성공 후  돈이빠져나간후에 함수를 호출한다(DB에서 coin의 값을 업데이트해줌.)\r\n");
      out.write("\t\t\t// 함수 호출 \r\n");
      out.write("\t\t\twindow.opener.goPaymentUpdate();\r\n");
      out.write("\t\t\t// 결제 성공시 goPaymentUpdate 페이지로 가게 된다. \r\n");
      out.write("\r\n");
      ...
      out.write("         // location.href=\"/SaintLaura/payment.ysl\";\r\n");
      out.write("            \r\n");
      out.write("            window.opener.goPaymentUpdate();\r\n");
      out.write("            \r\n");
      out.write("            self.opener = self;\r\n");
