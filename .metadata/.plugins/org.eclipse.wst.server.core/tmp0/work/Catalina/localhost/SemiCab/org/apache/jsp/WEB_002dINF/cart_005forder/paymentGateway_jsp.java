 ...
 * Generated at: 2019-12-20 05:57:43 UTC
...
public final class paymentGateway_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("   IMP.init('imp41974598');  // 중요!!  아임포트에 가입시 부여받은 \"가맹점 식별코드\".  \r\n");
      out.write("\t\r\n");
      out.write("   // 결제요청하기\r\n");
      out.write("   IMP.request_pay({\r\n");
      out.write("       pg : 'html5_inicis', // 결제방식 PG사 구분\r\n");
      out.write("       pay_method : 'card',\t// 결제 수단 - 홈페이지 보면은 카드,휴대폰결제, 실시간이체 등 나와있다. 그걸 보고 작성하면 된다.\r\n");
      out.write("       merchant_uid : 'merchant_' + new Date().getTime(), // 가맹점에서 생성/관리하는 고유 주문번호\r\n");
      out.write("       name : '결제테스트',\t // 코인충전 또는 order 테이블에 들어갈 주문명 혹은 주문 번호. (선택항목)원활한 결제정보 확인을 위해 입력 권장(PG사 마다 차이가 있지만) 16자 이내로 작성하기를 권장\r\n");
      out.write("       amount : 100,\t  //'");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${paymentPrice}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write('\'');
      out.write(' ');
      out.write('\'');
      ...
      out.write("' 현재는 100원으로 test 한다.  결제 금액 number 타입. 필수항목. \r\n");
      ...
      out.write("       m_redirect_url : '192.168.50.45:9090/SemiCab/cart_order/main.ej'   \r\n");
      ...
      out.write("\t\t\topener.location.href = \"http://www.aaa.com\";\r\n");
      out.write("\t\t\t\r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${coinmoney}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("');\";   \t\t\t\t\r\n");
      out.write("\t\t\twindow.opener.goBilgInsert('");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${paymentPrice}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("');  \r\n");
      out.write("\t\t//\t결재를 했으면 DB에 코인을 올려줄 함수를 호출하는 것이다.\r\n");
      ...
      out.write("\t\t    \r\n");
      out.write("        } else {\r\n");
      out.write("         //   location.href=\"/SemiCab/main.ej\";\r\n");
